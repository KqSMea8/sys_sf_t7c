...
(function ($) {
    $.fn.SmohanPopLayer = function (options) {
        var Config = {
            ...
            Event: "click",
            Content: "Content",
            Title: "Smohan.net.htm" /*tpa=http://www.jq22.com/demo/jquery-share201708072303/scripts/Smohan.net*/
        };
        ...
        layerhtml += '<div class="Smohan_Layer_box" style=" margin-top:-' + layer_top + 'px;margin-left:-150px;'  + 'px;display:none;" id="layer_' + options.Content + '">';
...
$(document).ready(function (e) {
    ...
    // location.href
    var share_url = encodeURIComponent("http://www.baidu.com");
    ...
    $('#Share li a.share1').click(function (e) {
        window.open("https://reactjs.org/docs/react-component.html#setstate?url=" + share_url + "&title=" + share_title + "&pics=" + share_pic + "&site=" + share_from + "", "newwindow");
    });
