 ...
 */  
class Aliyun{  
    private $accessKeyId = "LTAIK0Nbk525a1F3";          //密钥ID  
    private $accessKeySecret = "sHHLOrhCU7bvThBOze2b6jE09uuMch";      //密钥  
    public  $version = "2014-11-11";    //API版本号  
    public  $format = "JSON";           //返回值类型  
    private $domainParameters = "";  
    public  $video_host='video-center-bj.alivecdn.com';                //推流域名  
    public  $appName="yichong";            //应用名  
    public  $privateKey="livekey";             //鉴权  
    public  $vhost="live1.aiegi.cn";                  //加速域名  
    public  $msg;  
