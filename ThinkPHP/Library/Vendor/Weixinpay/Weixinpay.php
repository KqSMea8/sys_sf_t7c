...
class Weixinpay {
    ...
    private $config=array(
        'APPID'              => 'wx33715f77a6554167', // 微信支付APPID
        'MCHID'              => '1494721582', // 微信支付MCHID 商户收款账号
        'KEY'                => 'yichong123456789yichong123456789', // 微信支付KEY
        'APPSECRET'          => 'ed01b8f9ff07a32e6217dc44eb46e327',  //公众帐号secert
        'NOTIFY_URL'         => 'http://47.92.53.249/index.php/Home/Wxpay/notify', // 接收支付状态的连接  改成自己的域名
        );
