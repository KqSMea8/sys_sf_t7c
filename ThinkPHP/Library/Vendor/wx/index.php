...
class TestpayAction{
    ...
    */
    var $config = array(
    'appid' => "wx33715f77a6554167",    /*微信开放平台上的应用id*/
        'mch_id' => "1494721582",   /*微信申请成功之后邮件中的商户id*/
        'api_key' => "yichong123456789yichong123456789",    /*在微信商户平台上自己设定的api密钥 32位*/
        'notify_url' => 'http://www.ymyg8888.com/Index/Index/lists/id/4.html' /*自定义的回调程序地址*/
    ); 
  //获取预支付订单
    public function wxpay(){
        $url = "https://api.mch.weixin.qq.com/pay/unifiedorder";
        $notify_url = $this->config["notify_url"];
        $out_trade_no = '54522454545';
        $total_fee    = 0.1*100;
