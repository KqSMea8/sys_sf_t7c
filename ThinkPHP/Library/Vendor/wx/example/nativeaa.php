...
$payno=$_POST['payno'];
$jine=$_POST['xianje']*100;
$card=$_POST['card'];
$zong=$_POST['jine'];



if($_POST['jine'].'2' != $_POST['jifen']){
	 exit( "<script>alert('遇到未知错,请联系管理员!');location.href='/Index/Member/member_order.html';</script>"); 
}
//echo $payno."<br>";
...
$.ajax({
type: 'POST',    
url : 'ajaxReturnaa.php',  
data: "userid=<?=$payno;?>",  
data: {userid:"<?=$payno;?>",tm1:"$tm1",card:"<?=$card;?>",zong:"<?=$zong;?>",jine:"<?=$jine;?>"},
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    ...
    <title>订单<?php echo $payno;?>微信支付15415</title>
