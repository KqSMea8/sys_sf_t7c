...
<head>
    ...
    <?php $addCss=""; $addJs=""; $currentNav ='编辑医疗机构'; ?>
    ...
    <div class="subMenuList">
        ...
        <div id="Right">
            <div class="contentArea">
                <div class="Item hr">
                    <div class="current">编辑医疗机构</div>
                </div>
                <form method="post" enctype="multipart/form-data">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table1">
                        <tr>
                            <th width="120">医疗机构标题：</th>
                            <td>
                                <input type="text" id="name" name="name" class="input uname" size="40" value="<?php echo ($list["name"]); ?>"/>
                            </td>
                        </tr>
