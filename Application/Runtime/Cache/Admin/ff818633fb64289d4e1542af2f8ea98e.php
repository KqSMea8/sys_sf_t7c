...
<head>
    ...
    <?php $addCss=""; $addJs=""; $currentNav ='编辑法律援助机构'; ?>
...
<body>
        <div id="Right" style="float:none;width:100%">
            <div class="contentArea">
                <div class="Item hr">
                    <div class="current">编辑法律援助机构</div>
                </div>
                <form method="post" enctype="multipart/form-data">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table1">
                        <tr>
                            <th width="120">法律援助机构名称：</th>
                            <td>
                        ...
                        <tr>
                            ...
                            <th width="120">机构传真:</th>
                            <td>
                                <input type="text" name="jgcz" class="input uname" size="40" value="<?php echo ($list["jgcz"]); ?>"/>
                            </td>
                            <th width="120">机构邮编:</th>
                            <td>
                                <input type="text" name="jgyb" class="input uname" size="40" value="<?php echo ($list["jgyb"]); ?>"/>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <th width="120">邮箱:</th>
                            <td>
                                <input type="text" name="yx" class="input uname" size="40" value="<?php echo ($list["yx"]); ?>"/>
                            </td>
                        </tr>
                        <tr>
...
<script type="text/javascript">
        $(function(){
            ...
            $(".submit").click(function(){
             ...
             var url='/index.php/conist/Institution/yz_add';
