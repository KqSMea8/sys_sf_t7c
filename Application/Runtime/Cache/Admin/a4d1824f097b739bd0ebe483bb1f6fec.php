...
<head>
    ...
    <?php $addCss=""; $addJs=""; $currentNav ='编辑考试类型'; ?>
    ...
    <div class="subMenuList">
        ...
        <div id="Right">
            <div class="contentArea">
                <div class="Item hr">
                    <div class="current">编辑考试类型</div>
                </div>
                <form method="post" enctype="multipart/form-data">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table1">
                        <tr>
                            <th width="120">考试类型名称：</th>
                            <td>
                                <input type="text" name="name" class="input uname" size="40" value="<?php echo ($list["name"]); ?>"/>
                            </td>
                        </tr>
                        <tr>
                            <th width="120">考试类型题目数量：</th>
                            <td>
                                <input type="text"  onchange="if(/\D/.test(this.value)){alert('只能输入数字');this.value='';}" name="subject_num" class="input uname" size="40" value="<?php echo ($list["subject_num"]); ?>"/>(数字正整数)
                            </td>
                        </tr>
                        <tr>
                            <th width="120">考试类型总分：</th>
                            <td>
                                <input type="text"  onchange="if(/\D/.test(this.value)){alert('只能输入数字');this.value='';}" name="total_points" class="input uname" size="40" value="<?php echo ($list["total_points"]); ?>"/>(数字正整数)
                            </td>
                        </tr>
                        <tr>
                            <th width="120">考试类型图片：</th>
                            <td>
