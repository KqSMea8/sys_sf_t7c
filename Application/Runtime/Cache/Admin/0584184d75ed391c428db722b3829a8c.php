...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>法律服务所列表-<?php echo ($site["SITE_INFO"]["name"]); ?></title>
        <?php $addCss=""; $addJs=""; $currentNav ='法律服务所列表'; ?>
    ...
    <body>
        <div id="Right" style="float:none;width:100%">
            <div class="Item hr">
                ...
                <!-- <div style="width: 150px;float: right;"><button type="button" class="btn" onclick="window.location.href='<?php echo U('Institution/fw_add');?>'">添加法律服务所</button><button type="button" class="btn" onclick="window.location.href='<?php echo U('Institution/fw_member_add');?>'">添加基层法律工作者</button></div> -->
            </div>
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab">
                ...
                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr align="center" id="<?php echo ($vo["id"]); ?>">
                        ...
                        <td><?php echo ($vo["zzxs"]); ?></td>
                        <td><?php echo ($vo["jgzh"]); ?></td>
                        <td><?php echo ($vo["fzr"]); ?></td>
                        <td><?php echo ($vo["qy"]); ?></td>
                        <td><?php echo (date("Y-m-d H:i:s",$vo["createtime"])); ?></td>
                        <td><a id="<?php echo ($vo["id"]); ?>" class="memberList_fw" href="javascript:;">人员列表 </a></td>
                        <td>
                        <!-- <?php if($cate == 1): ?>[ <a id="<?php echo ($vo["id"]); ?>" class="memberList_fw" href="javascript:;">人员列表 </a> ]<?php endif; ?> -->
                        [ <a id="<?php echo ($vo["id"]); ?>" class="editList_fw" href="javascript:;">编辑 </a> ] 
                        [ <a link="<?php echo U('Institution/fw_del/',array('id'=>$vo['id']));?>" href="javascript:void(0)" name="<?php echo ($vo["name"]); ?>" class="del">删除 </a> ]
                        </td>
        ...
        <script type="text/javascript">
            $(function(){
                ...
                $('body').on('click','.memberList_fw',function(){
                    var id=$(this).attr('id');
                    var url='/index.php/conist/Institution/fw_member_add?gid='+id;
                    ...
                    var urls='/index.php/conist/Institution/fw_member?id='+id;
                    showFirme(urls);
                })
                $('body').on('click','.editList_fw',function(){
                    var id=$(this).attr('id');
                    var url='/index.php/conist/Institution/fw_add?id='+id;
                    showFirme(url);
                })
            });
