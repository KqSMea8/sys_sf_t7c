...
<head>
    ...
    <?php $addCss=""; $addJs=""; $currentNav ='编辑普法宣传'; ?>
            ...
            <div class="contentArea">
                ...
                <form method="post" enctype="multipart/form-data">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table1">
                        ...
                        <tr>
                            <th width="120">普法宣传简介：</th>
                            <td>
                                <textarea class="intro" style="height: 300px; width: 50%;" name="intro"><?php echo ($list['intro']); ?></textarea>
                            </td>
                        </tr>
                        <tr>
                            <th width="120">普法宣传内容：</th>
                            <td>
