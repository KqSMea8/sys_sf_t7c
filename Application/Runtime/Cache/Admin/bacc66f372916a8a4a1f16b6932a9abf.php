...
<head>
    ...
    <?php $addCss=""; $addJs=""; $currentNav ='用户协议'; ?>
                ...
                <form method="post" enctype="multipart/form-data">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table1">
                         <tr>
                            <th width="120">内容：</th>
                            <td>
                                <textarea class="content" style="height: 300px; width: 50%;" name="content"><?php echo ($list['user_agreement']); ?></textarea>
                            </td>
                        </tr>
                    </table>
