...
<head>
    ...
    <?php $addCss=""; $addJs=""; $currentNav ='编辑视频维护人员'; ?>
    ...
    <div class="subMenuList">
        ...
        <div id="Right">
            <div class="contentArea">
                <div class="Item hr">
                    <div class="current">编辑视频维护人员</div>
                </div>
                <form method="post" enctype="multipart/form-data">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table1">
                      <tr>
                        <td style="color: red;" id="top_click">服务区域维护</td>
                        <td id="down_click">客服人员维护</td>
                      </tr>
                    <?php if($is_canshu != 1): ?><tbody id="top_box">
                        <tr>
                      ...
                      <tbody id="down_box" style="display: none;">
                        <tr>
...
<script type="text/javascript">
 ...
 $(".submit").click(function(){
    ...
    var id = $("input[name='id']").val();
     $.ajax({
            type: "POST",
            url: "https://sft.t7c.net/index.php/conist/Video/serve_video_member_edit",
            data: {
                mid: mid,
                uid:uid,
                type:type,
...
$("#top_click").on('click',function(){
  $(this).css('color','red');
  $("#down_click").css('color','black')
    $("#top_box").show();
    $("#down_box").hide();
});
$("#down_click").on('click',function(){
  $(this).css('color','red');
  $("#top_click").css('color','black')
    $("#top_box").hide();
    $("#down_box").show();
});
</script>
