...
<head>
    ...
    <?php $addCss=""; $addJs=""; $currentNav ='编辑预约类别'; ?>
    ...
    <div class="subMenuList">
        ...
        <div id="Right">
            <div class="contentArea">
                <div class="Item hr">
                    <div class="current">编辑预约类别</div>
                </div>
                <form method="post" enctype="multipart/form-data">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table1">
                        <tr>
                            <th width="120">预约类别标题：</th>
                            <td>
                                <input type="text" name="title" class="input uname" size="40" value="<?php echo ($list["title"]); ?>"/>
                            </td>
                        </tr>
                      	<tr>
                            <th width="120">预约类别附件数量：</th>
                            <td>
                                <input type="text" name="file_num" class="input uname" size="40" value="<?php echo ($list["file_num"]); ?>"/>
                            </td>
                        </tr>
                      	<tr>
                            <th width="120">预约类别描述：</th>
                            <td>
                                <input type="text" name="required_type" class="input uname" size="40" value="<?php echo ($list["required_type"]); ?>"/>
                            </td>
                        </tr>
                    </table>
