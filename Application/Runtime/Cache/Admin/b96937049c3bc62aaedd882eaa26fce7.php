...
<head>
    ...
    <?php $addCss=""; $addJs=""; $currentNav ='关于我们'; ?>
                ...
                <form method="post" enctype="multipart/form-data">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table1">
                        <tr>
                            <th width="120">内容：</th>
                            <td>
                                <textarea style="margin: 0px; width: 456px; height: 306px;" name="about"><?php echo ($list["about"]); ?></textarea>
                            </td>
                        </tr>
                        <tr>
                            <th width="120">图片：</th>
                        ...
                        <tr>
                            <th width="120"></th>
                            <td>
                                <?php if($list['about_img'] != ''): ?><div style="width:300px;height:300px;">
                                    <img src="<?php echo ($list["about_img"]); ?>" style="width:200px;height:200px;">
                                </div><?php endif; ?>
                            </td>
                        </tr>
                    </table>
