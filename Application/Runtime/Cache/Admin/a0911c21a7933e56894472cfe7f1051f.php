...
<head>
    ...
    <?php $addCss=""; $addJs=""; $currentNav ='编辑推送消息'; ?>
                ...
                <form method="post" enctype="multipart/form-data">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table1">
                        ...
                        <tr>
                            <th width="120"></th>
                            <td>
                                <?php if($list['adjunct'] != ''): ?><div>
                                    <?php echo ($list["adjunct"]); ?>
                                </div><?php endif; ?>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <textarea class="content" style="height: 300px; width: 50%;" name="text"><?php echo ($list["text"]); ?></textarea>
                            </td>
                        </tr>
                    </table>
