            ...
            <form id="form1" action="" method="post">
                <div class="loginInfo">
                    <ul>
                        ...
                        <li class="row2"><input class="input" name="email" id="email" size="30" type="text" value="bigqig@126.com"/></li>
                    </ul>
                    <ul>
                        <li class="row1">登录密码：</li>
                        <li class="row2"><input class="input" name="pwd" id="pwd" size="30" type="password" value="123"/></li>
                    </ul>
                    <ul>
