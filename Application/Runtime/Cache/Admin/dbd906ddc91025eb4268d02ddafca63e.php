...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>下载项维护-<?php echo ($site["SITE_INFO"]["name"]); ?></title>
        <?php $addCss=""; $addJs=""; $currentNav ='App版本号更新维护'; ?>
...
<div id="Top">
            ...
            <?php if(is_array($sub_menu)): foreach($sub_menu as $key=>$sv): if($sv["sub3"] != 'false'): ?><li class="togellernav"><a><?php echo ($sv["title"]); ?></a>
                ...
                <div id="Right">
                    <div class="Item hr">
                        ...
                        <div style="width: 100px;float: right;"><button type="button" class="btn" onclick="window.location.href='<?php echo U('App/add');?>'">添加版本号</button></div>
                    </div>
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab">
                        ...
                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr align="center" id="<?php echo ($vo["id"]); ?>">
                                <td align="left"><a href="/index.php/conist/App/edit?id=<?php echo ($vo["id"]); ?>"><?php echo ($vo["title"]); ?></a></td>
                                ...
                                <td>[ <a href="/index.php/conist/App/add?id=<?php echo ($vo["id"]); ?>">编辑 </a> ] [ <a link="<?php echo U('App/del/',array('id'=>$vo['id']));?>" href="javascript:void(0)" name="<?php echo ($vo["title"]); ?>" class="del">删除</a> ]</td>
    ...
    $(function(){
		...
		$.ajax({
			type: "get",
			url: "<?php echo U("Product/change_jz");?>",
			data: {
		 		id: id
			},
			dataType: "json",
