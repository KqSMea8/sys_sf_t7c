...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>调解员列表-<?php echo ($site["SITE_INFO"]["name"]); ?></title>
        <?php $addCss=""; $addJs=""; $currentNav ='调解员列表'; ?>
    ...
    <body>
                <div id="Right" style="float:none;width:100%">
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab">
                        ...
                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr align="center" id="<?php echo ($vo["id"]); ?>">
                                ...
                                <td><?php echo ($vo["sstwh"]); ?></td>
                                <td><?php echo ($vo["zw"]); ?></td>
                                <td><?php echo ($vo["xb"]); ?></td>
                                <td><?php echo ($vo["zzmm"]); ?></td>
                                <td><?php echo (date("Y-m-d H:i:s",$vo["createtime"])); ?></td>
                                <td>[ <a id="<?php echo ($vo["id"]); ?>" gid="<?php echo ($gid); ?>" class="edit_List_tj" href="javascript:;">编辑 </a> ] [ <a link="<?php echo U('Institution/tj_member_del/',array('id'=>$vo['id'],'gid'=>$gid));?>" href="javascript:void(0)" name="<?php echo ($vo["xm"]); ?>" class="del">删除 </a> ]</td>
        ...
        <script type="text/javascript">
            ...
            $('body').on('click','.edit_List_tj',function(){
                ...
                var url='/index.php/conist/Institution/tj_member_add?id='+id+'&gid='+gid;
                showFirme(url);
            })
