...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>打卡记录列表-<?php echo ($site["SITE_INFO"]["name"]); ?></title>
        <?php $addCss=""; $addJs=""; $currentNav ='打卡记录列表'; ?>
                ...
                <div id="Right">
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab">
                        ...
                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr align="center" id="<?php echo ($vo["id"]); ?>">
                                ...
                                <td><?php echo ($vo["special_personnel"]["name"]); ?></td>
                                <td><?php echo ($vo["special_personnel"]["id_card"]); ?></td>
                                <td><?php echo ($vo["special_personnel"]["mobile"]); ?></td>
                                <td><?php echo ($vo["personal"]["id"]); ?></td>
                                ...
                                <td>[ <a href="/index.php/conist/User/clock_info?id=<?php echo ($vo["id"]); ?>">详情 </a> ]<!--  [ <a link="<?php echo U('User/special_personnel_del/',array('id'=>$vo['id']));?>" href="javascript:void(0)" name="<?php echo ($vo["name"]); ?>" class="del">删除 </a> ] --></td>
