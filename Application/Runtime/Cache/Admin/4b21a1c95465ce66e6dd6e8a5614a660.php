...
<head>
    ...
    <?php $addCss=""; $addJs=""; $currentNav ='编辑费用'; ?>
                ...
                <form method="post" enctype="multipart/form-data">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table1">
                        <tr>
                            ...
                            <td>
                                <select id="bussiness_id" name="bussiness_id">
                                    <?php if(is_array($bussiness)): $i = 0; $__LIST__ = $bussiness;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>" <?php if($vo['id'] == $list['bussiness_id']): ?>selected<?php endif; ?>><?php echo ($vo["title"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                </select>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" name="num" class="input uname" size="40" value="<?php echo ($list["num"]); ?>"/>
                            </td>
                        </tr>
                        <tr>
                            <th width="120">所需附件个数：</th>
                            <td>
                                <input type="text" name="file_num" class="input uname" size="40" value="<?php echo ($list["file_num"]); ?>"/>
                            </td>
                        </tr>
          				<tr>
                            <th width="120">所需附件名称（每个名称以逗号隔开）：</th>
                            <td>
                                <input type="text" name="file_name" class="input uname" size="40" value="<?php echo ($list["file_name"]); ?>"/>
                            </td>
                        </tr>
                    </table>
