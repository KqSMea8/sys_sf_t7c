...
<script type="text/javascript">
 ...
 $(".submit").click(function(){
    ...
    var pwd=$("input[name='pwd']").val();
     $.ajax({
            type: "POST",
            // url: "https://sft.t7c.net/index.php/conist/Video/serve_video_member_add",
            url: "https://sft.t7c.net/index.php/conist/Video/serve_video_canshu_add",
            data: {
                // mid: mid,
                // uid:uid,
                // type:type,
