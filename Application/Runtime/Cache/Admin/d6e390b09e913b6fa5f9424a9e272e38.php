...
<head>
    ...
    <?php $addCss=""; $addJs=""; $currentNav ='编辑鉴定人'; ?>
                ...
                <form method="post" enctype="multipart/form-data">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table1">
                        ...
                        <tr>
                            ...
                            <th width="120">所在机构编号:</th>
                            <td>
                            <?php if($list['gzdw'] != ''): ?><input type="text" name="szjgbh" class="input uname" size="40" value="<?php echo ($list["szjgbh"]); ?>" readonly="readonly" />
                                <?php else: ?>
                                <input type="text" name="szjgbh" class="input uname" size="40" value="<?php echo ($jgbh); ?>" readonly="readonly" /><?php endif; ?>
                            </td>
                        </tr>
                        <tr>
                            <th width="120">照片:</th>
                            ...
                            <th width="120">执业证有效期开始日期:</th>
                            <td>
                                <input type="date" name="zyzyxqkssj" class="input uname" size="40" value="<?php echo ($list["zyzyxqkssj"]); ?>"/>
                            </td>
                            <th width="120">执业证有效期结束日期:</th>
                            <td>
                                <input type="date" name="zyzyxqjssj" class="input uname" size="40" value="<?php echo ($list["zyzyxqjssj"]); ?>"/>
                            </td>
                        </tr>  
                        <tr>
                            <th width="120">职称:</th>
                        ...
                        <tr>
                            ...
                            <th width="120">执业方式:</th>
                            <td>
                                <input type="text" name="zyfs" class="input uname" size="40" value="<?php echo ($list["zyfs"]); ?>"/>
                            </td>
                            
                            <th width="120">司法部职称评定:</th>
                            <td>
                                <input type="text" name="sfbzcpd" class="input uname" size="40" value="<?php echo ($list["sfbzcpd"]); ?>"/>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <th width="120">执业行政区域:</th>
                            <td>
                                <input type="text" name="zyxzqy" class="input uname" size="40" value="<?php echo ($list["zyxzqy"]); ?>"/>
                            </td>
                            <th width="120">状态</th>
                            <td>
...
<script type="text/javascript">
        $(function(){
             ...
             $(".back").click(function(){
                ...
                var url='/index.php/conist/Institution/jd_member?id='+id;
                showFirme(url)
             })
            $(".submit").click(function(){
             ...
             var url='/index.php/conist/Institution/jd_member_add';
