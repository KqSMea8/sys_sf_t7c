...
<head>
    ...
    <?php $addCss=""; $addJs=""; $currentNav ='编辑政务公开'; ?>
                ...
                <form method="post" enctype="multipart/form-data">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table1">
                        ...
                        <tr>
                            ...
                            <td>
                                <select class="type_sel" name="type_id">
                                    ...
                                    <?php if(is_array($type)): $i = 0; $__LIST__ = $type;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>" status="<?php echo ($vo["area_status"]); ?>" <?php if($vo['id'] == $list['type_id']): ?>selected<?php endif; ?>><?php echo ($vo["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                </select>
                            </td>
                        </tr>
                        <tr class="qy">
                            ...
                            <td>
                                ...
                                <option value="0">全部</option>
                                    <?php if(is_array($qy)): $i = 0; $__LIST__ = $qy;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>" <?php if($vo['id'] == $list['area']): ?>selected<?php endif; ?>><?php echo ($vo["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                 </select>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <select name="cate">
                                    <option value="0">请选择</option>
                                    <option value="1" <?php if($list['cate'] == 1): ?>selected<?php endif; ?>>机构</option>
                                    <option value="2" <?php if($list['cate'] == 2): ?>selected<?php endif; ?>>人员</option>
                                </select>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <th width="120"></th>
                            <td>
                                <?php if($list['img_url'] != ''): ?><div style="width:300px;height:200px;">
                                    <img src="<?php echo ($list["img_url"]); ?>" style="width:200px;height:200px;">
                                </div><?php endif; ?>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <textarea class="content" style="height: 300px; width: 50%;" name="content"><?php echo ($list['content']); ?></textarea>
                            </td>
                        </tr>
                    </table>
