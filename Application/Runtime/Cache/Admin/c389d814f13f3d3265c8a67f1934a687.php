...
<head>
    ...
    <?php $addCss=""; $addJs=""; $currentNav ='编辑司法要闻'; ?>
            ...
            <div class="contentArea">
                ...
                <form method="post" enctype="multipart/form-data">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table1">
                        ...
                        <tr>
                            <th width="120">司法要闻简介：</th>
                            <td>
                                <textarea style="height: 150px; width: 30%;" name="intro"><?php echo ($list['intro']); ?></textarea>
                            </td>
                        </tr>
                        <tr>
                            <th width="120">司法要闻内容：</th>
                            <td>
