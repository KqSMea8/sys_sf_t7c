...
<head>
    ...
    <?php $addCss=""; $addJs=""; $currentNav ='编辑政务公开类型'; ?>
    ...
    <div class="subMenuList">
        ...
        <div id="Right">
            <div class="contentArea">
                <div class="Item hr">
                    <div class="current">编辑政务公开类型</div>
                </div>
                <form method="post" enctype="multipart/form-data">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table1">
                        <tr>
                            <th width="120">政务公开类型名称：</th>
                            <td>
                                <input type="text" name="name" class="input uname" size="40" value="<?php echo ($list["name"]); ?>"/>
                            </td>
                        </tr>
                        <tr>
                            <th width="120">是否需要选择区域：</th>
                            <td>
                                <input type="radio" name="area_status" class="input uname" value="1" <?php if($list['area_status'] == 1): ?>checked<?php endif; ?>/>是
                                <input type="radio" name="area_status" class="input uname" value="0" <?php if($list['area_status'] == 0): ?>checked<?php endif; ?>/>否
                            </td>
                        </tr>
                        <tr>
                            <th width="120">政务公开类型封面：</th>
                            <td>
