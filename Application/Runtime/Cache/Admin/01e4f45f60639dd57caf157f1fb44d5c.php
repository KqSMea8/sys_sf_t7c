...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>司法所人员列表-<?php echo ($site["SITE_INFO"]["name"]); ?></title>
        <?php $addCss=""; $addJs=""; $currentNav ='司法所人员列表'; ?>
...
<link href="/Public/Css/head.css" rel="stylesheet" type="text/css">
    ...
    <body>
                <div id="Right" style="float:none;width:100%">
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab">
                        ...
                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr align="center" id="<?php echo ($vo["id"]); ?>">
                                ...
                                <td><?php echo ($vo["rylx"]); ?></td>
                                <td><?php echo ($vo["xb"]); ?></td>
                                <td><?php echo ($vo["rybm"]); ?></td>
                                <td><?php echo (date("Y-m-d H:i:s",$vo["createtime"])); ?></td>
                                <td>[ <a id="<?php echo ($vo["id"]); ?>" gid="<?php echo ($gid); ?>" class="edit_List_sfs" href="javascript:;">编辑 </a> ] [ <a link="<?php echo U('Institution/sfs_member_del/',array('id'=>$vo['id'],'gid'=>$gid));?>" href="javascript:void(0)" name="<?php echo ($vo["xm"]); ?>" class="del">删除 </a> ]</td>
        ...
        <script type="text/javascript">
            ...
            $('body').on('click','.edit_List_sfs',function(){
                var id=$(this).attr('id');
                var gid=$(this).attr('gid');
                var url='/index.php/conist/Institution/sfs_member_add?id='+id+'&gid='+gid;
                showFirme(url);
            })
