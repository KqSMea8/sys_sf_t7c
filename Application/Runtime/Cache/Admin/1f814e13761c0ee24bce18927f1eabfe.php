...
<head>
    ...
    <?php $addCss=""; $addJs=""; $currentNav ='编辑表格'; ?>
                ...
                <form method="post" enctype="multipart/form-data">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table1">
                        ...
                        <tr>
                            <th width="120"></th>
                            <td>
                                <?php if($list['path'] != ''): ?><div style="width:300px;height:200px;">
                                    <?php echo ($list["path"]); ?>
                                </div><?php endif; ?>
                            </td>
                        </tr>
                    ...
                    <?php if($list['form_id'] != ''): ?><input type="hidden" name="form_id" value="<?php echo ($list["form_id"]); ?>"/>
                    <?php else: ?>
                    <input type="hidden" name="form_id" value="<?php echo ($form_id); ?>"/><?php endif; ?>
