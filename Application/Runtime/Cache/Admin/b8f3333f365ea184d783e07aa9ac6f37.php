...
<head>
    ...
    <?php $addCss=""; $addJs=""; $currentNav ='编辑视频类别'; ?>
    ...
    <div class="subMenuList">
        ...
        <div id="Right">
            <div class="contentArea">
                <div class="Item hr">
                    <div class="current">编辑视频类别</div>
                </div>
                <form method="post" enctype="multipart/form-data">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table1">
                        <tr>
                            <th width="120">视频类别标题：</th>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" name="url" class="input uname" size="40" value="<?php echo ($list["url"]); ?>">
                            </td>
                        </tr>
                        <tr class="qy">
                            <th width="120">区域：</th>
                            <td>
                                ...
                                <option value="0">全部</option>
                                    <?php if(is_array($qy)): $i = 0; $__LIST__ = $qy;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>" <?php if($vo['id'] == $list['area_id']): ?>selected<?php endif; ?>><?php echo ($vo["title"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                 </select>
                            </td>
                        </tr>
                    </table>
